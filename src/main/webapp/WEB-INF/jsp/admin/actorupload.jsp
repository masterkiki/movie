		...
		<div class="d-flex">
			...
			<section class="contents d-flex justify-content-center align-items-center ">
				<div>
					...
					<div class="d-flex align-items-center mt-4">
						<label class="col-3 text-center ">국가</label>
						<input type="text" class="form-control col-3">
					...
					<div>
						...
						<textarea class="ml-4 form-control" style="width:95%;"></textarea>
					</div>
					<div>
						<button class="mt-3 btn btn-primary" style="float:right;">다음</button>
					</div>
				</div>
			</section>
		</div>
